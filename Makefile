...
#
PACKAGE_NAME = CcdCameraChameleon
MAJOR_VERS   = 1
MINOR_VERS   = 0
...
ADDITIONAL_OBJS = \
		$(OBJDIR)/camerachameleon.o \
		$(OBJDIR)/BeamAnalyzer.o
...
$(OBJDIR)/camerachameleon.o:  camerachameleon.cpp $(SVC_INCL)
	$(CXX) $(CXXFLAGS) -c $< -o $(OBJDIR)/camerachameleon.o
$(OBJDIR)/BeamAnalyzer.o:  BeamAnalyzer.cpp $(SVC_INCL)
	$(CXX) $(CXXFLAGS) -c $< -o $(OBJDIR)/BeamAnalyzer.o
